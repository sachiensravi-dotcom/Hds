...
function Btn2() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#ffa62a] content-stretch flex items-center justify-center left-[calc(50%+0.5px)] px-[20px] py-[16px] rounded-[120px] top-[449px]" data-name="btn">
