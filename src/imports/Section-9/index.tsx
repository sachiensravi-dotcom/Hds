import svgPaths from "./svg-ps4q8uzy4l";
...
function MaskGroup() {
  return (
    <div className="absolute h-[212px] left-[40px] top-[427px] w-[1360px]" data-name="Mask group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1360 212">
        <g id="Mask group">
          <mask height="212" id="mask0_5_252" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="1360" x="0" y="0">
            <g id="Union">
          ...
          <g mask="url(#mask0_5_252)">
            <path d={svgPaths.p2b8cdb00} fill="url(#paint0_linear_5_252)" id="Ellipse 3 (Stroke)" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_5_252" x1="1025" x2="1025" y1="-26" y2="1332">
