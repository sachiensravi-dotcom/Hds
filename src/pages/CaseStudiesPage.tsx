  ...
  return (
    <div className="bg-[#141414] min-w-[1440px] overflow-x-hidden">
      ...
      <div className="flex flex-col items-center justify-center h-[400px] text-white">
        <h1 className="text-4xl font-['Inter_Tight'] mb-4">Case Studies</h1>
        <p className="text-[#989898] font-['Geist_Mono'] uppercase tracking-widest">Real results for real businesses</p>
      </div>
